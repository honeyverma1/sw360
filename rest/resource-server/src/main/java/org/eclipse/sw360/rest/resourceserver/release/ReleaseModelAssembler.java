...
public class ReleaseModelAssembler {
    ...
    static final ImmutableMap<Release._Fields,String> mapOfFieldsTobeEmbedded = ImmutableMap.of(
    ...
    Map<String, Object> createReleaseBatchSummaryItem(Release release) {
